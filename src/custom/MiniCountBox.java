...
public class MiniCountBox extends JPanel {
    private JLabel minusButton, plusButton, countLabel;
    private int count = 1;
    public MiniCountBox(int count) {
        this.count = count;
        this.setBorder(new EmptyBorder(3, 5, 3, 5));
        this.setBackground(Setup.white);
        this.setBorder(BorderFactory.createLineBorder(Setup.checkBoxBorderColor, 1));

        GridBagLayout searchTextLayout = new GridBagLayout();
        searchTextLayout.columnWidths = new int[]{20, 25, 20, 0, 0};
        ...
        minusButton.setIcon(new ImageIcon(MiniCountBox.class.getResource("/images/countminus.png")));
        this.add(minusButton, searchBagCon);


        countLabel = new JLabel(count + "");
        countLabel.setFont(new Font(Setup.font, Font.PLAIN, 12));
        ...
        plusButton.setIcon(new ImageIcon(MiniCountBox.class.getResource("/images/countplus.png")));
