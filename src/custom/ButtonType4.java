...
public class ButtonType4 extends JButton implements MouseListener {
	private Color buttonColor = Setup.white;
	private boolean over = false;
	private int round;
	public ButtonType4(int width, int height, int round, String text, int fontSize) {
		this.round = round;
