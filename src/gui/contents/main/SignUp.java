...
public class SignUp extends JPanel {
	...
	public SignUp() {
		...
		//ID
			...
			idDesLabel.setBounds(10, 70, 140, 15);
		...
		//PASSWORD
			...
			passDesLabel.setBounds(10, 70, 140, 15);
		...
		//PASSCHECK
			...
			passCheckTextField.setBounds(0, 30, 500, 40);
			...
			passCheckDesLabel.setBounds(10, 70, 140, 15);
		...
		//NICKNAME
			...
			nickNameTextField.setBounds(0, 30, 500, 40);
		...
		//NAME
			...
			nameTextField.setBounds(0, 30, 500, 40);
			...
			nameDesLabel.setBounds(10, 70, 140, 15);
		...
		//BIRTH
			...
			birthDesLabel.setBounds(10, 70, 130, 15);
		...
		//EMAIL
			...
			emailTextField.setBounds(0, 30, 500, 40);
			...
			emailDesLabel.setBounds(10, 70, 140, 15);
			emailPanel.add(emailDesLabel);
			
		//JOINBTN
			JPanel joinBtnPanel = new JPanel();
			joinBtnPanel.setBounds(410, 710, 130, 45);
		...
		//haveAcc
			...
			haveAccPanel.setBounds(285, 770, 300, 30);
			...
			loginLabel.setBounds(252, 1, 57, 15);
